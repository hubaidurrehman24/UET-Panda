...
const OrderManagement = ()=>{
    ...
    const [availableRiders, setAvailableRiders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderManagement.useEffect": ()=>{
            ...
            const unsubOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(qOrders, {
                "OrderManagement.useEffect.unsubOrders": (snapshot)=>{
                    const data = snapshot.val();
                    if (data) {
                        const o = Object.entries(data).map({
                            "OrderManagement.useEffect.unsubOrders.o": ([id, val])=>({
                                    id,
                                    ...val
                                })
                        }["OrderManagement.useEffect.unsubOrders.o"]);
                        o.sort({
                            "OrderManagement.useEffect.unsubOrders": (a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
                        }["OrderManagement.useEffect.unsubOrders"]);
                        setOrders(o);
                    } else {
                        setOrders([]);
                    }
            ...
            // Fetch Riders
            const ridersRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$config$2f$src$2f$firebase$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], `riders/${cafeId}`);
            const unsubRiders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onValue"])(ridersRef, {
                "OrderManagement.useEffect.unsubRiders": (snapshot)=>{
                    const data = snapshot.val();
                    if (data) {
                        const r = Object.entries(data).map({
                            "OrderManagement.useEffect.unsubRiders.r": ([id, val])=>({
                                    id,
                                    ...val
                                })
                        }["OrderManagement.useEffect.unsubRiders.r"]);
                        setAvailableRiders(r);
                    } else {
                        setAvailableRiders([]);
                    }
                }
            }["OrderManagement.useEffect.unsubRiders"]);
            return ({
                "OrderManagement.useEffect": ()=>{
                    unsubOrders();
                    unsubRiders();
        ...
        try {
            ...
            if (newStatus === "Delivered" || newStatus === "Collected") {
                ...
                if (order && order.riderId) {
                    updates[`riders/${cafeId}/${order.riderId}/deliveryCount`] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["increment"])(1);
                }
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["update"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$config$2f$src$2f$firebase$2f$config$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"]), updates);
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                            ...
                                                            children: [
                                                                ...
                                                                availableRiders.map((rider)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                        value: rider.id,
                                                                        children: [
                                                                            rider.name,
                                                                            " - ",
                                                ...
                                                availableRiders.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(OrderManagement, "1dsfgs5azcWg89PTys2Qr94jMSM=", false, function() {
    return [
