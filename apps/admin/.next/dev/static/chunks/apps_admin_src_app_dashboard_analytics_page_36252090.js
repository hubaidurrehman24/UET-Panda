...
"[project]/apps/admin/src/app/dashboard/analytics/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AnalyticsPage = ()=>{
    ...
    const [codSales, setCodSales] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [onlineSales, setOnlineSales] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
                ...
                "AnalyticsPage.useEffect.unsubscribe": (snapshot)=>{
                    ...
                    if (data) {
                        ...
                        const o = Object.entries(data).map({
                            "AnalyticsPage.useEffect.unsubscribe.o": ([id, val])=>({
                                    id,
                                    ...val
                                })
                        }["AnalyticsPage.useEffect.unsubscribe.o"]).filter({
                            "AnalyticsPage.useEffect.unsubscribe.o": (ord)=>ord.status === "Delivered"
                        }["AnalyticsPage.useEffect.unsubscribe.o"]);
                        setOrders(o);
                        const total = o.reduce({
                            "AnalyticsPage.useEffect.unsubscribe.total": (sum, order)=>sum + order.total
                        }["AnalyticsPage.useEffect.unsubscribe.total"], 0);
                        const cod = o.filter({
                            "AnalyticsPage.useEffect.unsubscribe.cod": (ord)=>ord.paymentMethod === 'cod'
                        }["AnalyticsPage.useEffect.unsubscribe.cod"]).reduce({
                            "AnalyticsPage.useEffect.unsubscribe.cod": (sum, order)=>sum + order.total
                        }["AnalyticsPage.useEffect.unsubscribe.cod"], 0);
                        const online = o.filter({
                            "AnalyticsPage.useEffect.unsubscribe.online": (ord)=>ord.paymentMethod === 'stripe'
                        }["AnalyticsPage.useEffect.unsubscribe.online"]).reduce({
                            "AnalyticsPage.useEffect.unsubscribe.online": (sum, order)=>sum + order.total
                        }["AnalyticsPage.useEffect.unsubscribe.online"], 0);
                        setTotalSales(total);
                        setCodSales(cod);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            orders.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                className: "space-y-6",
                                children: orders.slice(0, 5).map((ord)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AnalyticsPage, "SnhElxK33ZvEyVyGqdZU/gO3BAI=", false, function() {
    return [
...
//# sourceMappingURL=apps_admin_src_app_dashboard_analytics_page_36252090.js.map